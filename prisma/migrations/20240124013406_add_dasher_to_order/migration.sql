...
INSERT INTO "new_Order" ("_id", "destinationDorm", "destinationRoom", "locationId", "paid", "phone", "price", "userId") SELECT "_id", "destinationDorm", "destinationRoom", "locationId", "paid", "phone", "price", "userId" FROM "Order";
DROP TABLE "Order";
